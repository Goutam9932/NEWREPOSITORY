...
public class EditUserController {
    ...
    public String getUserById(@PathVariable Long id, Model model) {
        ...
        if (userById != null) {
            ...
            model.addAttribute("editUserFirstLetter", userById.getUserName().substring(0, 1).toUpperCase());
    ...
    public String updateUser(@PathVariable Long id, @ModelAttribute User user,
        ...
        // Add the first letter of the edited user to the model
        model.addAttribute("editUserFirstLetter", user.getUserName().substring(0, 1).toUpperCase());
